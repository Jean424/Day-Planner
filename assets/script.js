...
// 7am Local Storage
$("#7btn").click(function(){
    let input7am = document.getElementById("7").value
    localStorage.setItem("7am", JSON.stringify(input7am))
})
let output7am = JSON.parse(localStorage.getItem("7am"));
document.getElementById("7").value = output7am


// 8am Local Storage
$("#8btn").click(function(){
    let input8am = document.getElementById("8").value
    localStorage.setItem("8am", JSON.stringify(input8am))
})
let output8am = JSON.parse(localStorage.getItem("8am"));
document.getElementById("8").value = output8am
...
$("#10btn").click(function(){
    let input10pm = document.getElementById("10").value
